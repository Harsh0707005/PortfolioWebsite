    ...
    return(
        <div className = 'p-[30px]' >
            ...
            {projects[projectFor].map((project, index) => (
                <div key={index + project.title} className="relative flex bg-clip-border rounded-xl bg-white text-gray-700 border-gray-500 border-[1px] shadow-md w-full flex-row p-[20px]">
                    <div
                        className="relative w-2/5 m-0 overflow-hidden text-gray-700 bg-white bg-clip-border shrink-0 rounded-2xl border-black border-[1px]">
                        <img
